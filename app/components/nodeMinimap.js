        ...
        $timeout(function(){
          ...
          var settings = {}
            ...
            'rgba(180, 180, 180, .2)'
					...
					var background_node_size = settings.oversampling * settings.background_node_size
					var highlighted_node_size = settings.oversampling * settings.highlighted_node_size
